document.addEventListener("DOMContentLoaded", function() {
  ...
  for (let y = 1; y < 4; y++) {
    if (document.getElementById("row" + y)) {
    ...
    boxList[j].addEventListener(
      ...
      function() {
        ...
        let box = event.target,
          ...
          currOpacity = 1 - 0.19 * yPosition;

        //show current row's background image/label
        if (yPosition > 0)
          document.getElementById("row" + yPosition).style.backgroundImage =
            rowImageURLs[yPosition];
      ...
      function() {
        ...
        for (let x = 5; x > 0; x--) {
          for (let y = 3; y > 0; y--) {
            ...
            //show current row's background image/label
            document.getElementById("row" + y).style.backgroundImage =
              rowImageURLs[y];
          }
        }
      },
